...
function doRectanglesOverlap(rect1, rect2) {
  ...
  return isInsideRectangleB(rect1.left, rect1.top) || isInsideRectangleB(rect1.left + rect1.width, rect1.top) || isInsideRectangleB(rect1.left, rect1.top + rect1.height) || isInsideRectangleB(rect1.left + rect1.width, rect1.top + rect1.height) || isInsideRectangleA(rect2.left, rect2.top) || isInsideRectangleA(rect2.left + rect2.width, rect2.top) || isInsideRectangleA(rect2.left, rect2.top + rect2.height) || isInsideRectangleA(rect2.left + rect2.width, rect2.top + rect2.height);
}
...
function findFirstSingleChar(str) {
  return str.split('').find((i, index, a) => a.indexOf(i) === a.lastIndexOf(i)) || null;
}
...
function getDigitalRoot(num) {
  return num < 10 ? num : getDigitalRoot(num.toString().split('').reduce((ac, cur) => ac + +cur, 0));
}
...
function evaluateTicTacToePosition(position) {
  let win;
  let check = position.some((_a, i, arr) => {
